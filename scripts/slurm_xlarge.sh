...
#
# Resource class "xlarge" of the benchmark. Submit from the repo root.
#
#   sbatch --array=1-N scripts/slurm_xlarge.sh configs/benchmark/manifest_xlarge.txt
#   sbatch            scripts/slurm_xlarge.sh configs/benchmark/generated/<e>/<a>.yaml
#
...
#   sbatch --time=02:00:00 --mem=16G --array=1-10 scripts/slurm_xlarge.sh <manifest>
